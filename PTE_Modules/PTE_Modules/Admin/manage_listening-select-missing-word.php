...
?>
    ...
    <body data-sidebar="dark">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table mb-8">
                                                ...
                                                <tbody>
                                                 <?php $sel1="select * from missing_word";
      ...
      <td><?php echo $row1['radiobutton1']; ?></td>
      <td><?php echo $row1['radiobutton2']; ?></td>
      <td><?php echo $row1['radiobutton3']; ?></td>
      <td><?php echo $row1['radiobutton4']; ?></td>
       <td><?php echo $row1['radiobutton5']; ?></td>
      <td> <?php echo $row1['answer']; ?></td>      
    
        <td class="center">
                                          <a href="?da_id= <?php echo $row1['id']; ?>"><button type="button" class="btn btn-primary"><i class="fa fa-edit "></i>
                    Delete
                  </button></a>
