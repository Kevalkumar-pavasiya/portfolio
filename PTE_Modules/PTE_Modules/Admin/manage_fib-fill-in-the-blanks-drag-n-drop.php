...
$wid=$_SESSION['data1'];
$no=$_GET['no'];
header("location:select_fib-fill-in-the-blanks-drag-n-drop.php?w_id=$wid&no=$no");
}
if(isset($_GET['d_id'])){
$id=$_GET['d_id'];
...
<?php
        ...
        $total_pages_sql = "SELECT COUNT(*) FROM words_blank_line";
...
<table class="table table-hover" width="100%">
    <tr>
		...
		<?php 
$sel="select * from words_blank_line LIMIT $offset, $no_of_records_per_page";
...
while ($rows=mysqli_fetch_assoc($res)) {
 ?>
		...
		<tr >
			...
			<td style="border: none;" width="30px"><a href="?s_id=<?php echo $rows['w_id']; ?>"><button class="btn btn-primary" id="btn_select">Select</button></a></td>
			<td style="border: none;" width="30px"><a href="?d_id=<?php echo $rows['w_id'];?>"><button class="btn btn-danger" type="submit">Delete</button></a></td>
		</tr>
		<?php  } ?>
	</table>
                 <nav>
