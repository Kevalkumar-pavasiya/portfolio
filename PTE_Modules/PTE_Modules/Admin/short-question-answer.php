...
<?php $cn=mysqli_connect("localhost","thevisio_visionoverseas","UeZuxw#q-_&j","thevisio_eduction");
...
if(isset($_POST['up_audio'])){      
        ...
        $ins="insert into answer_question(name,Aud_Path,answer) values('$name','$data3','$answer')";
        echo $ins;
        mysqli_query($cn,$ins);
...
if(isset($_GET['da_id'])){
    $id=$_GET['da_id'];
    $del="delete from short-answer-question where id='$id'";
    echo $del;
    mysqli_query($cn,$del);
}
?>
