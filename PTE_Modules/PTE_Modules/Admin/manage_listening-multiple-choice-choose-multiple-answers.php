...
?>
    ...
    <body data-sidebar="dark">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table mb-8">
                                                ...
                                                <tbody>
                                                 <?php $sel1="select * from listening_multiple";
      ...
      <td><?php echo $row1['checkbox1']; ?></td>
      <td><?php echo $row1['checkbox2']; ?></td>
      <td><?php echo $row1['checkbox3']; ?></td>
      <td><?php echo $row1['checkbox4']; ?></td>
      <td><?php echo $row1['checkbox5']; ?></td>
      <td><?php echo $row1['checkbox6']; ?></td>
