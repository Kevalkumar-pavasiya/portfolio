...
<?php include('includes/header.php'); ?>
        <?php 
           ...
           include 'config.php';
            ...
            if(isset($_GET['da_id'])){
    $id=$_GET['da_id'];
    $del="delete from Highlight_incorrect_words where id='$id'";
    echo $del;
    mysqli_query($cn,$del);
}
?>
    ...
    <body data-sidebar="dark">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table mb-8">
                                                ...
                                                <tbody>
                                                 <?php $sel1="select * from Highlight_incorrect_words";
      ...
      <td><?php echo $row1['W_pra']; ?></td>
      <td><?php echo $row1['R_pra']; ?></td>
