...
if(isset($_POST['up_audio'])){      
        ...
        $ins="insert into missing_word (name,Aud_Path,question,radiobutton1,radiobutton2,radiobutton3,radiobutton4,radiobutton5,answer) values('$name','$data3','$question','$radiobutton1','$radiobutton2','$radiobutton3','$radiobutton4','$radiobutton5','$answer')";
        
        mysqli_query($cn,$ins);
                $status = "New Record Inserted Successfully.</br></br><a href='manage_listening-select-missing-word.php'>View Inserted Record</a>";
...
if(isset($_GET['da_id'])){
    $id=$_GET['da_id'];
    $del="delete from missing_word where id='$id'";
    echo $del;
    mysqli_query($cn,$del);
}
?>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                <label for="formrow-firstname-input">Radio Button 5 Details</label>
                                                 <textarea type="text" id="textarea" class="form-control" name="radiobutton5" required="required" rows="3"></textarea> 
                                            </div>
