...
if(isset($_POST['up_audio'])){      
        ...
        // $R_pra=$_POST['R_pra'];
        $answer=$_POST['answer'];
        $W_pra=addslashes($_POST['W_pra']);
        $R_pra=addslashes($_POST['R_pra']);
        $Title=addslashes($_POST['Title']);
        $ins="insert into Highlight_incorrect_words (Aud_Path,W_pra,R_pra,answer,Title) values('$data3','$W_pra','$R_pra','$answer','$Title')";
       
        mysqli_query($cn,$ins);

         $status = "New Record Inserted Successfully.</br></br><a href='manage_listening-highlight-the-correct-summary.php'>View Inserted Record</a>";
...
if(isset($_GET['da_id'])){
    $id=$_GET['da_id'];
    $del="delete from highlight_correct_summary where id='$id'";
    echo $del;
    mysqli_query($cn,$del);
}
?>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                <label for="formrow-firstname-input"> Wrong Paragraph</label>
                                                 <textarea type="text" id="textarea" class="form-control" name="W_pra" required="required" ></textarea> 
                                            </div>
                                            
                                             <div class="form-group">
                                                <label for="formrow-firstname-input"> Right Paragraph</label>
                                                 <textarea type="text" id="textarea" class="form-control" name="R_pra" required="required" ></textarea> 
                                            </div>
