...
if(isset($_POST['up_audio'])){      
        ...
        $ins="insert into highlight_correct_summary (name,Aud_Path,question,radiobutton1,radiobutton2,radiobutton3,radiobutton4,answer) values('$name','$data3','$question','$radiobutton1','$radiobutton2','$radiobutton3','$radiobutton4','$answer')";
