...
if(isset($_POST['up_audio'])){      
        ...
        $ins="insert into audio (name,Aud_Path,answer) values('$name','$data3','$answer')";
       
        mysqli_query($cn,$ins);
      
      $status = "New Record Inserted Successfully.</br></br><a href='manage-repeat-sentence.php'>View Inserted Record</a>";
}
