...
<head>
    ...
    <!-- Title -->
    <title>SST – Summarize Spoken Text | Vision Overseas</title>
    <!-- Favicon -->
...
<main>
        ...
        <div class="container">
            <div class="row">
                <div class="lernen_banner_title">
                    <h1>SST – Summarize Spoken Text</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <?php
        if (isset($_GET['id'])) {
            ...
            $sql = "SELECT * FROM youtube WHERE You_Id='$id' ";
            ...
            <div class="row justify-content-center text-center">
                <div class="col-lg-8">
                    <div class="">
                        ...
                        <hr>
                        <br>
                        <?php echo $row['You_Path']; ?>
                        <div>
                                <textarea class="input-text required-field"  name="contactMessage" id="contactMessage"
                                    placeholder="Message" title="Your Message" rows="13" cols="100" onkeyup="countWords(this);"></textarea>
                                <span style="float: left; color: black" id="count-words"></span>
                        </div>
                        <script type="text/javascript"> 
                                function countWords(self) 
                                {
                                    ...
                                    document.getElementById("count-words").innerHTML = words + " = Your words";
                                }
                            </script>
        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-lg-2">
                    <div class="">
                            <?php
                                $previous= mysqli_query($cn, "SELECT * FROM youtube WHERE You_Id<$id order by You_Id DESC");
                                if($row = mysqli_fetch_array($previous))
                                {
                                    echo '<a href="summarize_spoken_text_view.php?id='.$row['You_Id'].'">
                ...
                <div class="col-lg-2">
                    <div class="">
                        <?php
                            $next = mysqli_query($cn, "SELECT * FROM youtube WHERE You_Id>$id order by You_Id ASC");
