                ...
                <div class="lernen_banner_title">
                    ...
                    <div class="lernen_breadcrumb">
                        <div class="breadcrumbs">
                            ...
                            <span class="last-item">Answer Short Questions</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-lg-8">
                    ...
                    $total_pages_sql = "SELECT COUNT(*) FROM answer_question";
                 ...
                 <tr>
		            ...
		            <?php 
                    $sel="select * from answer_question LIMIT $offset, $no_of_records_per_page";
		        	...
		        	<tr align="left">
            			<td width="30px"><?php echo $count++; ?></td>
               			<td><a href="answer_short_questions_view.php?id=<?php echo $rows['id'];?>"><p><?php echo $rows['name'];?></p></a> </td>
	            	</tr>
	            	<?php  } ?>
            	</table>
                 <nav>
