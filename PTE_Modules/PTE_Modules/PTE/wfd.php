                ...
                <div class="lernen_banner_title">
                    ...
                    <div class="lernen_breadcrumb">
                        <div class="breadcrumbs">
									...
									<a href="index.html">Writing</a></span>
                            <span class="separator">&gt;</span>
                            <span class="last-item">WFD – Write from Dictation</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-lg-8">
                    ...
                    $total_pages_sql = "SELECT COUNT(*) FROM single_user";
                 ...
                 <tr>
		            ...
		            <?php 
                    $sel="select * from single_user LIMIT $offset, $no_of_records_per_page";
		        	...
		        	<tr align="left">
            			<td width="30px"><?php echo $count++; ?></td>
               			<td><a href="wfd_user.php?id=<?php echo $rows['id'];?>"><p><?php echo $rows['name'];?></p></a> </td>
	            	</tr>
	            	<?php  } ?>
            	</table>
                 <nav>
