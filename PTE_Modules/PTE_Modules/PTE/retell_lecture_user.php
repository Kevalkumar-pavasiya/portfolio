...
<head>
    ...
    <!-- Title -->
    <title>Retell Lacture | Vision Overseas</title>
    <!-- Favicon -->
                ...
                <div class="lernen_banner_title">
                    ...
                    <div class="lernen_breadcrumb">
                        <div class="breadcrumbs">
                            ...
                            <span class="last-item">Retell Lacture</span>
                        </div>
                    </div>
                </div>
            </div>
                 ...
                 <tr>
		        	...
		        	<tr align="left">
            			<td width="30px"><?php echo $count++; ?></td>
               			<td><a href="retell_lecture_view.php?id=<?php echo $rows['You_Id'];?>"><p><?php echo $rows['name'];?></p></a> </td>
	            	</tr>
	            	<?php  } ?>
            	</table>
                 <nav>
