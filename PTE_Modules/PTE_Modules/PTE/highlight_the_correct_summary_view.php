...
<main>
        ...
        <div class="container">
            <div class="row">
                <div class="lernen_banner_title">
                    <h1>Highlight the Correct Summary</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <?php
        if (isset($_GET['id'])) {
            ...
            $sql = "SELECT * FROM highlight_correct_summary WHERE id='$id' ";
        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-lg-2">
                    <div class="">
                            <?php
                                $previous= mysqli_query($cn, "SELECT * FROM highlight_correct_summary WHERE id<$id order by id DESC");
                                if($row = mysqli_fetch_array($previous))
                                {
                                    echo '<a href="highlight_the_correct_summary_view.php?id='.$row['id'].'">
                ...
                <div class="col-lg-2">
                    <div class="">
                        <?php
                            $next = mysqli_query($cn, "SELECT * FROM highlight_correct_summary WHERE id>$id order by id ASC");
