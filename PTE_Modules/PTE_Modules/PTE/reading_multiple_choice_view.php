            ...
            <div class="row justify-content-center text-center">
                <div class="col">
                    <div class="">
                        ...
                        <hr>
                        <p style="text-align:justify"><?php echo $row['paragraph'] ?></p>
                        <br>
                        ...
                        <input type="checkbox">
                            <label> <p><?php echo $row["checkbox7"]; ?></p></label><br>
                        </div>
        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-lg-2">
                    <div class="">
                            <?php
                                $previous= mysqli_query($cn, "SELECT * FROM multipleselect WHERE id<$id order by id DESC");
                                if($row = mysqli_fetch_array($previous))
                                {
                                    echo '<a href="reading_multiple_choice_view.php?id='.$row['id'].'">
                ...
                <div class="col-lg-2">
                    <div class="">
                        <?php
                            $next = mysqli_query($cn, "SELECT * FROM multipleselect WHERE id>$id order by id ASC");
