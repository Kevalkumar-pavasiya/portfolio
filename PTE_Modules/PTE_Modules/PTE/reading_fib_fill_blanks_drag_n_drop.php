                ...
                <div class="lernen_banner_title">
                    ...
                    <div class="lernen_breadcrumb">
                        <div class="breadcrumbs">
                            ...
                            <span class="last-item">Fill In The Blanks (Drag & Drop)</span>
                        </div>
                    </div>
                </div>
            </div>
...
while ($rows=mysqli_fetch_assoc($res)) {
 ?>
		...
		<tr align="left">
			...
			<td><a href=reading_fib_fill_blanks_drag_n_drop_view.php?w_id=<?php echo $rows['w_id'];?>"><p><?php echo $rows['w_title'];?></p></a> </td>
		</tr>
		<?php  } ?>
	</table>
                 <nav>
