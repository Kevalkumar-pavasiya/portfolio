...
<head>
    ...
    <!-- Title -->
    <title>SWT - Summarize Written Text | Vision Overseas</title>
    <!-- Favicon -->
        ...
        <div class="container">
            <div class="row">
                <div class="lernen_banner_title">
                    <h1>SWT - Summarize Written Text</h1>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div>
                            ...
                            <script type="text/javascript"> 
                                function countWords(self) 
                                {
                                    ...
                                    document.getElementById("count-words").innerHTML = words + " = Toal words"
                                }
                            </script>
        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-lg-2">
                    <div class="">
                            <?php
                                $previous= mysqli_query($cn, "SELECT * FROM swt WHERE id<$id order by id DESC");
                                if($row = mysqli_fetch_array($previous))
                                {
                                    echo '<a href="swt_view.php?id='.$row['id'].'">
                ...
                <div class="col-lg-2">
                    <div class="">
                        <?php
                            $next = mysqli_query($cn, "SELECT * FROM swt WHERE id>$id order by id ASC");
