...
<main>
    ...
    <?php
        if (isset($_GET['id'])) {
            ...
            $sql = "SELECT * FROM aloud WHERE id='$id' ";
            ...
            <div class="row justify-content-center text-center">
                <div class="col-lg-8">
                    <div class="">
                        ...
                        <hr>
                        <br>
                        <p style="text-align: justify; "><?php echo $row['question'] ?></p>
        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-lg-2">
                    <div class="">
                            <?php
                                $previous= mysqli_query($cn, "SELECT * FROM aloud WHERE id<$id order by id DESC");
                                if($row = mysqli_fetch_array($previous))
                                {
                                    echo '<a href="read_aloud_view.php?id='.$row['id'].'">
                ...
                <div class="col-lg-2">
                    <div class="">
                        <?php
                            $next = mysqli_query($cn, "SELECT * FROM aloud WHERE id>$id order by id ASC");
