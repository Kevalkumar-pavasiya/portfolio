...
<head>
    ...
    <!-- Title -->
    <title>WFD – Write from Dictation | Vision Overseas</title>
    <!-- Favicon -->
...
<main>
        ...
        <div class="container">
            <div class="row">
                <div class="lernen_banner_title">
                    <h1>WFD – Write from Dictation</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <?php
        ...
        include 'dbconn.php';
            ...
            $sql = "SELECT * FROM single_user WHERE id ='$id' ";
        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-lg-2">
                    <div class="">
                            <?php
                                $previous= mysqli_query($cn, "SELECT * FROM single_user WHERE id<$id order by id DESC");
                                if($row = mysqli_fetch_array($previous))
                                {
                                    echo '<a href="wfd_user.php?id='.$row['id'].'">
                ...
                <div class="col-lg-2">
                    <div class="">
                        <?php
                            $next = mysqli_query($cn, "SELECT * FROM single_user WHERE id>$id order by id ASC");
