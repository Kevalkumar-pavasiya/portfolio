...
<head>
 ...
 <!-- Metas Basic -->
    ...
    <!-- Title -->
    <title>Repeat Sentence | Vision Overseas</title>
    <!-- Favicon -->
...
<main>
    ...
    <?php
        if (isset($_GET['id'])) {
            ...
            $sql = "SELECT * FROM audio WHERE Aud_Id ='$id' ";
                    ...
                    <div class="">
                        ...
                        <br>
                            <audio controls autoplay >
                                 <source src="<?php echo $row['Aud_path']; ?>" type="audio/mp3">
                            </audio>
        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-lg-2">
                    <div class="">
                            <?php
                                $previous= mysqli_query($cn, "SELECT * FROM audio WHERE Aud_Id<$id order by Aud_Id DESC");
                                if($row = mysqli_fetch_array($previous))
                                {
                                    echo '<a href="repeat_sentence_view.php?id='.$row['Aud_Id'].'">
                ...
                <div class="col-lg-2">
                    <div class="">
                        <?php
                            $next = mysqli_query($cn, "SELECT * FROM audio WHERE Aud_Id>$id order by Aud_Id ASC");
