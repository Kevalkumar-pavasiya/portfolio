...
<main>
        ...
        <div class="container">
            <div class="row">
                <div class="lernen_banner_title">
                    <h1>Listening – Multiple Choice (Single)</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <?php
        ...
        $sql = "SELECT * FROM listening_single WHERE id='$id' ";
        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-lg-2">
                    <div class="">
                            <?php
                                $previous= mysqli_query($cn, "SELECT * FROM listening_single WHERE id<$id order by id DESC");
                                if($row = mysqli_fetch_array($previous))
                                {
                                    echo '<a href="listening_multiple_choice_single_view.php?id='.$row['id'].'">
                ...
                <div class="col-lg-2">
                    <div class="">
                        <?php
                            $next = mysqli_query($cn, "SELECT * FROM listening_single WHERE id>$id order by id ASC");
