...
<main>
    ...
    <?php 
        include 'dbconn.php';
        $sql = "SELECT * FROM Highlight_incorrect_words";
        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-lg-8">
                    ...
                    $total_pages_sql = "SELECT COUNT(*) FROM Highlight_incorrect_words";
                 ...
                 <tr>
		            ...
		            <?php 
                    $sel="select * from Highlight_incorrect_words LIMIT $offset, $no_of_records_per_page";
		        	...
		        	<tr align="left">
            			<td width="30px"><?php echo $count++; ?></td>
               			<td><a href="Highlight_incorrect_words.php?id=<?php echo $rows['id'];?>"><p><?php echo $rows['Title'];?></p></a></td>
	            	</tr>
	            	<?php  } ?>
            	</table>
                 <nav>
