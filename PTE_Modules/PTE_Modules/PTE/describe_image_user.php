                ...
                <div class="lernen_banner_title">
                    ...
                    <div class="lernen_breadcrumb">
                        <div class="breadcrumbs">
                            ...
                            <span class="last-item">Describe Image</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center text-center">
                <div class="col-lg-8">
                 ...
                 <tr>
		            ...
		            <?php 
                    $sel="select * from images LIMIT $offset, $no_of_records_per_page";
		        	...
		        	<tr align="left">
            			<td width="30px"><?php echo $count++; ?></td>
               			<td><a href="describe_image_view.php?id=<?php echo $rows['Img_Id'];?>"><p><?php echo $rows['name'];?></p></a> </td>
	            	</tr>
	            	<?php  } ?>
            	</table>
                 <nav>
