                ...
                <div class="col">
                    <div class="">
                        ...
                        <div >
                            ...
                            <div class="radio">
                                <label><input type="radio" name="optradio" checked> <?php echo $row["radiobutton5"]; ?></label>
                            </div>
                            <div class="radio">
                                <label><input type="radio" name="optradio"> <?php echo $row["radiobutton6"]; ?></label>
                            </div>
                            <div class="radio">
                                <label><input type="radio" name="optradio" checked>   <?php echo $row["radiobutton7"]; ?></label>
                            </div> 
                        </div>
        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-lg-2">
                    <div class="">
                            <?php
                                $previous= mysqli_query($cn, "SELECT * FROM singleselect WHERE id<$id order by id DESC");
                                if($row = mysqli_fetch_array($previous))
                                {
                                    echo '<a href="Reading_select_single_view.php?id='.$row['id'].'">
                ...
                <div class="col-lg-2">
                    <div class="">
                        <?php
                            $next = mysqli_query($cn, "SELECT * FROM singleselect WHERE id>$id order by id ASC");
