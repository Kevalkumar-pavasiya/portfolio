...
<head>
    ...
    <!-- Title -->
    <title>RO – Reorder Paragraphs | Vision Overseas</title>
    <!-- Favicon -->
...
<main>
                ...
                <div class="lernen_banner_title">
                    ...
                    <div class="lernen_breadcrumb">
                        <div class="breadcrumbs">
                            ...
                            <span class="last-item">RO – Reorder Paragraphs</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="contact" class="wrap-bg wrap-bg">
        ...
        $total_pages_sql = "SELECT COUNT(*) FROM recorder";
...
<table class="table table-hover" width="100%">
    <tr>
		...
		<?php 
$sel="select * from recorder LIMIT $offset, $no_of_records_per_page";
...
while ($rows=mysqli_fetch_assoc($res)) {
 ?>
		...
		<tr align="left">
			...
			<td><a href="r1.php?w_id=<?php echo $rows['id'];?>"><p><?php echo $rows['name'];?></p></a> </td>
		</tr>
		<?php  } ?>
	</table>
                 <nav>
