                ...
                <div class="lernen_banner_title">
                    ...
                    <div class="lernen_breadcrumb">
                        <div class="breadcrumbs">
                            ...
                            <span class="last-item">SST – Summarize Spoken Text</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center text-center">
                <div class="col-lg-8">
                    <div class="section-title with-p">
                        <h2>SST – Summarize Spoken Text</h2>
                    ...
                    $total_pages_sql = "SELECT COUNT(*) FROM youtube";
                 ...
                 <tr>
		            ...
		            <?php 
                    $sel="select * from youtube LIMIT $offset, $no_of_records_per_page";
		        	...
		        	<tr align="left">
            			<td width="30px"><?php echo $count++; ?></td>
               			<td><a href="summarize_spoken_text_view.php?id=<?php echo $rows['You_Id'];?>"><p><?php echo $rows['name'];?></p></a> </td>
	            	</tr>
	            	<?php  } ?>
            	</table>
                 <nav>
