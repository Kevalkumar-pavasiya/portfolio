...
<main>
                ...
                <div class="lernen_banner_title">
                    ...
                    <div class="lernen_breadcrumb">
                        <div class="breadcrumbs">
                            ...
                            <span class="last-item">Highlight the Correct Summary</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <?php 
        include 'dbconn.php';
        $sql = "SELECT * FROM  highlight_correct_summary";
            ...
            <div class="row justify-content-center text-center">
                <div class="col-lg-8">
                    <div class="section-title with-p">
                        <h2>Highlight the Correct Summary</h2>
                    ...
                    $total_pages_sql = "SELECT COUNT(*) FROM highlight_correct_summary";
                 ...
                 <tr>
		            ...
		            <?php 
                    $sel="select * from highlight_correct_summary LIMIT $offset, $no_of_records_per_page";
		        	...
		        	<tr align="left">
            			<td width="30px"><?php echo $count++; ?></td>
               			<td><a href="highlight_the_correct_summary_view.php?id=<?php echo $rows['id'];?>"><p><?php echo $rows['name'];?></p></a> </td>
	            	</tr>
	            	<?php  } ?>
            	</table>
                 <nav>
