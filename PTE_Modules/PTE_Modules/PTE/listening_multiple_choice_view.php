...
<head>
    ...
    <!-- Title -->
    <title>Listening – Multiple Choice (Multiple) | Vision Overseas</title>
    <!-- Favicon -->
...
<main>
        ...
        <div class="container">
            <div class="row">
                <div class="lernen_banner_title">
                    <h1>Listening – Multiple Choice (Multiple)</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <?php
        ...
        $id = mysqli_real_escape_string($cn, $_GET['id']);
            $sql = "SELECT * FROM listening_multiple WHERE id='$id' ";
            ...
            <div class="row justify-content-center text-center">
                <div class="col">
                    <div class="">
                        ...
                        <div >
                        <input type="checkbox">
                            <label> <p><?php echo $row["checkbox1"]; ?></p></label><br>
                        <input type="checkbox">
                            <label> <p><?php echo $row["checkbox2"]; ?></p></label><br>
                        <input type="checkbox">
                            <label> <p><?php echo $row["checkbox3"]; ?></p></label><br>
                        <input type="checkbox">
                            <label> <p><?php echo $row["checkbox4"]; ?></p></label><br>
                        <input type="checkbox">
                             <label> <p><?php echo $row["checkbox5"]; ?></p></label><br>
                        <input type="checkbox">
                             <label> <p><?php echo $row["checkbox6"]; ?></p></label><br>
                        </div>
        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-lg-2">
                    <div class="">
                            <?php
                                $previous= mysqli_query($cn, "SELECT * FROM listening_multiple WHERE id<$id order by id DESC");
                                if($row = mysqli_fetch_array($previous))
                                {
                                    echo '<a href="listening_multiple_choice_view.php?id='.$row['id'].'">
                ...
                <div class="col-lg-2">
                    <div class="">
                        <?php
                            $next = mysqli_query($cn, "SELECT * FROM listening_multiple WHERE id>$id order by id ASC");
