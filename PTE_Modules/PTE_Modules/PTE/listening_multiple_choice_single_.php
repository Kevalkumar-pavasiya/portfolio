...
<head>
    ...
    <!-- Title -->
    <title>Listening – Multiple Choice (Single) | Vision Overseas</title>
    <!-- Favicon -->
...
<main>
                ...
                <div class="lernen_banner_title">
                    ...
                    <div class="lernen_breadcrumb">
                        <div class="breadcrumbs">
                            ...
                            <span class="last-item">Listening – Multiple Choice (Single)</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <?php 
        include 'dbconn.php';
        $sql = "SELECT * FROM  listening_single";
            ...
            <div class="row justify-content-center text-center">
                <div class="col-lg-8">
                    <div class="section-title with-p">
                        <h2>Listening – Multiple Choice (Single)</h2>
                    ...
                    $total_pages_sql = "SELECT COUNT(*) FROM listening_single";
                 ...
                 <tr>
		            ...
		            <?php 
                    $sel="select * from listening_single LIMIT $offset, $no_of_records_per_page";
		        	...
		        	<tr align="left">
            			<td width="30px"><?php echo $count++; ?></td>
               			<td><a href="listening_multiple_choice_single_view.php?id=<?php echo $rows['id'];?>"><p><?php echo $rows['name'];?></p></a> </td>
	            	</tr>
	            	<?php  } ?>
            	</table>
                 <nav>
