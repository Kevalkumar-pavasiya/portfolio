...
<head>
    ...
    <!-- Title -->
    <title>Reading - MCQ Multiple Select | Vision Overseas</title>
    <!-- Favicon -->
...
<main>
                ...
                <div class="lernen_banner_title">
                    ...
                    <div class="lernen_breadcrumb">
                        <div class="breadcrumbs">
                            ...
                            <span class="last-item">MCQ Multiple Select</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <?php 
        include 'dbconn.php';
        $sql = "SELECT * FROM  multipleselect";
        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-lg-8">
                    ...
                    $total_pages_sql = "SELECT COUNT(*) FROM multipleselect";
                 ...
                 <tr>
		            ...
		            <?php 
                    $sel="select * from multipleselect LIMIT $offset, $no_of_records_per_page";
		        	...
		        	<tr align="left">
            			<td width="30px"><?php echo $count++; ?></td>
               			<td><a href="reading_multiple_choice_view.php?id=<?php echo $rows['id'];?>"><p><?php echo $rows['name'];?></p></a> </td>
	            	</tr>
	            	<?php  } ?>
            	</table>
                 <nav>
