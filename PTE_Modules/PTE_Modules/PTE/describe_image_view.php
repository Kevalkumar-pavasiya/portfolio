...
<head>
    ...
    <!-- Title -->
    <title>Describe Image | Vision Overseas</title>
    <!-- Favicon -->
            ...
            <div class="row justify-content-center text-center">
                <div class="col-lg-8">
                    <div class="">
                        ...
                        <hr>
                        <br>
                        <img width="85%" src="<?php echo $row['Img_Path']; ?>">
        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-lg-2">
                    <div class="">
                            <?php
                                $previous= mysqli_query($cn, "SELECT * FROM images WHERE Img_Id<$id order by Img_Id DESC");
                                if($row = mysqli_fetch_array($previous))
                                {
                                    echo '<a href="describe_image_view.php?id='.$row['Img_Id'].'">
                ...
                <div class="col-lg-2">
                    <div class="">
                        <?php
                            $next = mysqli_query($cn, "SELECT * FROM images WHERE Img_Id>$id order by Img_Id ASC");
